...
saveRDS(cov_df, "M:\\Users\\uqfcho/Documents/seq-koala-monitoring/data-pipeline-output/cov_df.rds")
data.table::fwrite(cov_df, "M:\\Users\\uqfcho/Documents/seq-koala-monitoring/data-pipeline-output/cov_df.csv")
head(cov_df)
```
...
fcn_write_list_csv(df_datematched, 
                   path = "M:\\Users\\uqfcho/Documents/seq-koala-monitoring/data-pipeline-output/",
                   prefix = "transect_date_matched_")
```
