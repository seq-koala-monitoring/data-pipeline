...
route_table[,c('TransectID', 'GridID', 'lpercent')]
```
...
Rasterise fishnet
```{r}
fishnet_raster <- fcn_get_grid_raster()
extract_table <- fcn_line_sample_extract_raster(fishnet_raster, table_sf_2020)
event_table <- fcn_route_table_raster(fishnet_raster, table_sf_2020)
