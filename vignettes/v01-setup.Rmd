...
list.files(data_dir)
#>  [1] "2015-2019 SEQKoalaDatabase DES.accdb"  "2015-2019 SEQKoalaDatabase DES.laccdb"
#>  [3] "basedata.gdb"                          "final_covariates.gdb"                 
#>  [5] "final_covariates_raster"               "koala_survey_data_ver2_0.gdb"         
#>  [7] "KoalaSurveyData.gdb"                   "KoalaSurveyData.gdb.zip"              
#>  [9] "KoalaSurveyData2020_cur.accdb"         "KoalaSurveySites"                     
#> [11] "SEQkoalaData.accdb"                    "SEQkoalaData_info.pdf"                
#> [13] "SEQkoalaQueries.accdb"                 "test_grid.gdb"
```
